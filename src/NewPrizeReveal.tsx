  ...
  return (
    <div className="container">
      <div className="text-center">
        <h2 className="text-white mb-4">You've got a surprise! (New Lottie Player)</h2>
      ...
      <style>{`
        /* Styles remain the same as in the original PrizeReveal component */
        .container {
          display: flex;
